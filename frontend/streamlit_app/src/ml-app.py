...
def _generate_local_features(audio_bytes: bytes, label: str, engine: str):
    ...
    Extracts audio features using librosa directly in the main process.
    NUMBA_DISABLE_JIT=1 environment variable prevents JIT compilation issues.
    """
    try:
        # Load audio
        ...
        # Mel Spectrogram Parameters table
