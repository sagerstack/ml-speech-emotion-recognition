...
class PrometheusMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(
        ...
        self._requests_in_progress.labels(method=method, path=path, app_name=self.app_name).inc()

        # Increment request counter
        self._requests_total.labels(method=method, path=path, app_name=self.app_name).inc()
