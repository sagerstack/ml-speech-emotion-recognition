...
FEATURE_EXTRACTOR_PATH = Path(__file__).resolve().parents[2] / "models" / "v3" / "feature_extractor.py"
...
class TestV3VsOtherVersionsComparison:
    ...
    def test_v3_has_different_model_architecture_than_v1_and_v2(self, registry):
        ...
        assert v1_info["model_type"] != v2_info["model_type"], \
            "v1 and v2 should have different model types"
        assert v2_info["model_type"] != v3_info["model_type"], \
