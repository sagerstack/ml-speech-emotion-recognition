...
from app.infrastructure.observability.metrics.prometheus_middleware import PrometheusMiddleware
...
class TestPrometheusMiddlewareMetricNames:
    ...
    def test_app_info_metric_name_no_suffix(self) -> None:
        ...
        # Add middleware
        with patch("app.infrastructure.observability.metrics.prometheus_middleware.trace"):
